...
ax1.grid(linestyle='--')
labelLines(ax1.get_lines(), align=False, fontsize=12, xvals=(0, 130), yoffsets=0.05)
...
ax3.grid(linestyle='--')
labelLines(ax3.get_lines(), align=False, fontsize=12, yoffsets=0.05)
# right y-axis
ax4 = ax3.twinx()
...
ax4.grid(linestyle='--')
labelLines(ax4.get_lines(), align=False, fontsize=12)
